...
def upadete_bullets(screen, stats, sc, inos, bullets):
    """Обовлять позиции пуль"""
    bullets.update()
...
def check_hihg_score(stats, sc):
    """проверка новых рекордов"""
    if stats.score > stats.high_score:
        stats.high_score = stats.score
        sc.image_high_score()
        with open('high_scor.txt', 'w') as f:
